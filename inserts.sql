...
insert into products(name, price, type_register_id) values('Cola', 10000, 3),
('Pepsi', 10000, 3), ('Choy', 5000, 3);
...
insert into order_details(quantity, order_id, product_id) values(2, 1, 4);
insert into order_details(quantity, order_id, product_id) values(2, 1, 1);
insert into order_details(quantity, order_id, product_id) values(1, 2, 3);
insert into order_details(quantity, order_id, product_id) values(3, 3, 1);
insert into order_details(quantity, order_id, product_id) values(3, 3, 4);
insert into order_details(quantity, order_id, product_id) values(1, 4, 2);
insert into order_details(quantity, order_id, product_id) values(1, 4, 4);
insert into order_details(quantity, order_id, product_id) values(2, 5, 2);
insert into order_details(quantity, order_id, product_id) values(1, 6, 3);
insert into order_details(quantity, order_id, product_id) values(5, 7, 1);
insert into order_details(quantity, order_id, product_id) values(5, 7, 4);
insert into order_details(quantity, order_id, product_id) values(3, 8, 1);
insert into order_details(quantity, order_id, product_id) values(3, 8, 6);
